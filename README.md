...
**Blog Rails** is a personal webpage where I support a blog, as well as some of my projects.
...
```
  git clone git@github.com:jorgegoco/blog-rails.git
...
Feel free to check the [issues page](https://github.com/jorgegoco/blog-rails/issues).
